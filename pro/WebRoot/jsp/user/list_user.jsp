...
#info{
  ...
  .contex{
	...
	<script type="text/javascript">
			...
			location.href = "<s:url namespace="/user" action="fixBkUpPage.action" />?user.userId="+mid;
       ...
       <s:if test="userPow == 't'">
         <tr>
           ...
           <td><s:property value="userDate"/></td>
       	   ...
       	   <td>
           	<button id="delb" class="btn btn-default btn-sm" onclick = "upUser(<s:property value='userId'/>);" >
