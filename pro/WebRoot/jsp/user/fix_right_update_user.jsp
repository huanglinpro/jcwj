...
<div id="headtext">
	...
	<div id="updateform">
		<form action="/pro/user/finUNRight.action" class="form-horizontal" method="get">
			<s:textfield type="hidden"   name="user.userId" class="form-control" id="userId"></s:textfield>
			<s:textfield type="hidden"   name="user.singnPress" class="form-control" id="userI" value="aoa"></s:textfield>
			<s:textfield type="hidden"   name="user.payPass" class="form-control" id="useI" value="boa"></s:textfield>
			<input type="hidden" name="user.userPress" id="userPress">
			...
			<div class="form-group">
				<label for="userAddress" class="col-sm-2 control-label">权限:</label>
				<div class="col-sm-10">
				<!-- 	<input type="radio" name="user.userPow" value="f" checked="checked">冻结用户 -->
				<s:radio list="#{'t':'正常用户','f':'冻结用户'}" name="user.userPow"></s:radio>	
				</div>
			</div>
