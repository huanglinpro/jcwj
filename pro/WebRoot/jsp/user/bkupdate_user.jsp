...
<div id="headtext">
	...
	<div id="updateform">
		<form action="/pro/user/finRight.action" class="form-horizontal" method="get">
			<s:textfield type="hidden"   name="user.userId" class="form-control" id="erId"></s:textfield>
			<s:textfield type="hidden"   name="user.singnPress" class="form-control" id="userI" value="aaa"></s:textfield>
			<s:textfield type="hidden"   name="user.payPass" class="form-control" id="useI" value="baa"></s:textfield>
