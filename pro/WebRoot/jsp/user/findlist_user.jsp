     ...
     <table class="table table-striped table-hover">
       ...
       <s:iterator value="userlist">
         <tr>
           ...
           <td><s:property value="user.userPow"/></td>
           <td><s:property value="user.userDate"/></td>
           <td>
           		<button id="delb" class="btn btn-default btn-sm" onclick = "removeMes(<s:property value='user.'/>);" >
