    ...
    <script type="text/javascript" >
     ...
     $(document).ready(function(){
      ...
      var inf = document.getElementById("serchfor").value;
    	location.href="<s:url namespace="/shoes" action="scarchSches.action"/>?searchinfo="+inf;
      });
     ...
     <form class="form-horizontal" action="index.html" method="post">
       <div class="form-group">
         <div class="col-sm-12">
           ...
           <input type="text" class="form-control" id="serchfor" placeholder="请输入编号或者鞋子名称" name="searchinfo">
